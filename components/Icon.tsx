...
export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M18 19a3 3 0 1 1 .007-5.993"/>
        <path d="M6 12a3 3 0 1 1 .007-5.993"/>
        <path d="M6 5a3 3 0 1 1 .007-5.993"/>
        <path d="M12 5a3 3 0 1 1 .007-5.993"/>
        <path d="M18 12a3 3 0 1 0-5.993.142"/>
        <path d="M12.007 8A2.99 2.99 0 0 0 9 5.007"/>
        <path d="M12 13a3 3 0 1 0 0-6"/>
        <path d="m14.646 14.646 2.623 2.623"/>
        <path d="M6.007 8A2.99 2.99 0 0 0 3 5.007"/>
...
export const PuzzleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M20 10h-4v4h4a2 2 0 0 0 2-2v0a2 2 0 0 0-2-2Z"/>
        <path d="M10 14H6a2 2 0 0 0-2 2v0a2 2 0 0 0 2 2h4"/>
        <path d="M18 18v-4h4"/>
        <path d="M6 18v-4h4"/>
        <path d="M6 6h4v4H6a2 2 0 0 1-2-2v0a2 2 0 0 1 2-2Z"/>
    </svg>
);
...
export const MiniSpinner: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
