...
const ReasoningDisplay: React.FC<{ reasoning?: string }> = ({ reasoning }) => {
  ...
  return (
    <div className="mt-2 p-3 bg-gray-800/70 border-l-4 border-cyan-600 rounded-r-md">
      <div className="flex items-center">
        <LightbulbIcon className="h-4 w-4 mr-2 text-cyan-400 flex-shrink-0" />
        <p className="text-xs font-semibold text-cyan-400">AI Reasoning</p>
      </div>
    ...
    <div className="space-y-6">
       <div className="p-4 bg-gray-900/50 rounded-lg border border-gray-700">
         <div className="flex items-center mb-2">
            <FileCodeIcon className="h-6 w-6 mr-2 text-cyan-400" />
            <h2 className="text-lg font-semibold text-gray-200">On-Page SEO Elements</h2>
        </div>
        <p className="text-sm text-gray-400 mb-4">Craft the final SEO elements for the page.</p>
        <div className="space-y-4">
            <div>
              <div className="flex justify-between items-center mb-1">
                <label htmlFor="title_tag" className="block text-sm font-medium text-gray-300">Title Tag</label>
                <span className={`text-xs ${getCharCountClass(seoData.title_tag.value.length, 60)}`}>{seoData.title_tag.value.length} / 60</span>
              </div>
              <input type="text" id="title_tag" className="w-full p-2 bg-gray-800 border border-gray-600 rounded-md text-gray-300 focus:ring-2 focus:ring-cyan-500"
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                <label htmlFor="meta_description" className="block text-sm font-medium text-gray-300">Meta Description</label>
              ...
              <textarea id="meta_description" rows={3} className="w-full p-2 bg-gray-800 border border-gray-600 rounded-md text-gray-300 focus:ring-2 focus:ring-cyan-500"
            ...
            <div>
              <label htmlFor="h1" className="block text-sm font-medium text-gray-300 mb-1">H1</label>
              <input type="text" id="h1" className="w-full p-2 bg-gray-800 border border-gray-600 rounded-md text-gray-300 focus:ring-2 focus:ring-cyan-500"
            ...
            <div>
              <label htmlFor="url_slug" className="block text-sm font-medium text-gray-300 mb-1">URL Slug</label>
              <input type="text" id="url_slug" className="w-full p-2 bg-gray-800 border border-gray-600 rounded-md text-gray-300 focus:ring-2 focus:ring-cyan-500"
