...
import { ListTreeIcon, XIcon, PuzzleIcon, ZapIcon, FileTextIcon } from '../Icon';
...
const OutlineNode: React.FC<{
  ...
  return (
    <Card
      variant="outline"
      padding="md"
      className={`border-l-4 ${levelColors[item.level] || 'border-l-border'}`}
    ...
    >
      ...
      <div className="space-y-4">
        ...
        {item.reasoning && (
          <Callout variant="ai" title="AI Reasoning">
            {item.reasoning}
          </Callout>
        )}
  ...
  return (
    <div className="space-y-6">
      <Card variant="default" padding="md">
        ...
        <div>
          <h4 className="text-sm font-heading font-semibold text-text-primary mb-4">Content Outline</h4>
          <div className="space-y-4">
